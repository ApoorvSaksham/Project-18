...
if(boosterGrp.isTouching(mainCyclist)){
  ...
  power = createSprite(width-210,53,10,10);
  ...
  stroke("red");
  textFont("Algeria");
  text("Distance: "+ distance+" m",width-180,30);
  
  textSize(25);
  fill("pink");
  stroke("red");
  textFont("Algeria");
  text("Coins: "+ goldcoin,width-180,58);
  ...
  stroke("green");
  textFont("Algeria");
  text("Energy: ",width-310,55);
  
  textSize(25);
  fill("cyan");
  stroke("magenta");
  textFont("Algeria");
  text("Score: "+ score,width-310,30);
